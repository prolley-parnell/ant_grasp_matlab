classdef tbox
    ...
    methods (Static)
        ...
        %                         % Do not use the face with the smallest distance to
        %                         % the centre points but instead use the cross
        %                         % product with the
            ...
            for n = 1:nPoint
                ...
                if ~any(faceFlag)
                    ...
                    if zeroN == 2
                        ...
                        CB = barycentricToCartesian(fbTriang, twoFaceID', roundB([zeroRow],:));
                        pointOnObj(n,:) = mean(CB,1);
                    else
                        %If more than 2, or less than 2 values are 0, then
                        %get the normal of the nearest vertex instead
